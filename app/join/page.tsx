...
const ATTESTATIONS = [
  ...
  'The specialties, approaches, and identities I select — such as "trauma-informed" — reflect actual training and practice. I will not claim approaches or designations I am not trained and qualified to provide.',
